...
public class RowMapDeserializer extends StdDeserializer<RowMap> {
	private static final Logger LOGGER = LoggerFactory.getLogger(RowMapDeserializer.class);
	...
	private void readDataInto(RowMap dest, JsonNode data, boolean isOld) throws IOException {
		...
		LOGGER.info("readDataInto-->RowMap dest:{},JsonNode data:{}",dest.toString(),data.toString());
