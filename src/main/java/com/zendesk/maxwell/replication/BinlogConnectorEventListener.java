...
//		LOGGER.info("BinlogConnectorEventListener onEvent,event:{}",event.toString());
//		EventType type = event.getHeader().getEventType();
//		if(type.equals(EventType.EXT_WRITE_ROWS) || type.equals(EventType.EXT_UPDATE_ROWS) ||type.equals(EventType.EXT_DELETE_ROWS)){
//			LOGGER.info("onEvent,row:{}",event.getData().toString());
//		}
		long eventSeenAt = 0;
...
//					LOGGER.info("BinlogConnectorEventListener onEvent,queue:{},BinlogConnectorEvent:{}",queue.size(),ep.toString());
					break;
				}
