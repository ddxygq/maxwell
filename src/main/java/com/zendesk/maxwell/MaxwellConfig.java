...
//			LOGGER.info("");
			this.replicationMysql = new MaxwellMysqlConfig(
				...
				this.replicationMysql.replicationHost,
				this.replicationMysql.replicationPort,
				this.replicationMysql.replicationUser,
				this.replicationMysql.replicationPassword,
